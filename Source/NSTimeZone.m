...
+ (NSDictionary *)abbreviationDictionary
{
    ...
    if (abbreviationDictionary == nil) {
        ...
        if (path != nil) {
             ...
             */
            abbreviationDictionary = RETAIN([[NSString stringWithContentsOfFile:path] propertyList]);
        }
        if (abbreviationDictionary == nil) {
    ...
    if (systemTimeZone == nil) {
        ...
        if (localZoneString == nil) {
            ...
            if ([dflt fileExistsAtPath:SYSTEM_TIME_FILE]) {
                ...
                while ([tzdir length] > 2 && [dflt fileExistsAtPath:[tzdir stringByAppendingPathComponent:@"GMT"]] == NO) {
        ...
        if (localZoneString != nil) {
            ...
            if (zone == nil) {
                ...
                if (possibleZoneNames != nil) {
                    ...
                    while ((zoneName = [en nextObject]) != nil) {
                        ...
                        if (fileName != nil && [dflt contentsEqualAtPath:fileName
            ...
            if (zone == nil) {
                ...
                if ([localZoneSource hasPrefix:@"file"] || [localZoneSource hasPrefix:@"function"]) {
                    GSPrintf(stderr,
                             @"\nIt seems that your operating system does not have a valid timezone name\n"
...
+ (NSString *)_getTimeZoneFile:(NSString *)name
{
    ...
    if (beenHere == NO && tzdir == nil) {
        ...
        if (beenHere == NO && tzdir == nil) {
            ...
            for (i = 0; i < sizeof(zoneDirs) / sizeof(zoneDirs[0]); i++) {
                ...
                zonedir = [zoneDirs[i] stringByAppendingPathComponent:POSIX_TZONES];
    ...
    /* Use the system zone info if possible, otherwise, use our installed
       info.  */
    if (tzdir && [[NSFileManager defaultManager] fileExistsAtPath:[tzdir stringByAppendingPathComponent:name]
