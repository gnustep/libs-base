/** Implementation of a standalone (no libxml2) NSXMLParser for GNUStep
...
@interface GSStandaloneXMLParserIvars : NSObject
{
@public
  id			delegate;
...
@implementation	GSStandaloneXMLParserIvars
...
@interface	GSStandaloneXMLParser (Private)
- (NSString *) _newQarg;
@end

@implementation GSStandaloneXMLParser

#define EXTRA_DEBUG     0

#define	this	((GSStandaloneXMLParserIvars*)_standalone)
#define	_del	(this->delegate)
...
- (id) initWithData: (NSData *)data
{
  if (data == nil)
      ...
      if (self)
	{
	  ...
	  _standalone = (void*)[GSStandaloneXMLParserIvars new];
...
@implementation NSObject (GSStandaloneXMLParserDelegateEventAdditions)
