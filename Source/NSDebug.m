...
static gs_recursive_mutex_t	uniqueLock;
...
#define doLock() GS_RECURSIVE_MUTEX_LOCK(uniqueLock)
#define unLock() GS_RECURSIVE_MUTEX_UNLOCK(uniqueLock)
...
+ (void) initialize
{
  GS_RECURSIVE_MUTEX_INIT(uniqueLock);
}
@end
