...
<chapter>
  ...
  <section>
	...
	possibly containing an <em>email</em> element.<br />
	Where author information is missing, the author information will be
	replaced by the content of the SOURCE_AUTHOR_CREDIT environment
	variable or, if that is not set, 'Generated by:' and the name of the
	account of the person who is running the tool.
      </item>
	...
	of the GSDoc output.  If this is omitted or set to $Date$ the tool
	will use the value of the SOURCE_DATE_EPOCH environment variable
	(number of seconds since start of 1970) or, if that is not present,
	...
	of the GSDoc output.  If this is omitted or set to $Revision$, the
	tool will use the value supplied by the -Version command line argument
	(usually set by gnustep-make).
      </item>
    </list>
    <p>
  ...
  <section>
	...
	searched for in <code>DocumentationDirectory</code> (even though they
        may not have been autogenerated).<br />
	This is set by gnustep-make from the xxx_AGSDOC_LOCAL_DIR makefile
	variable.
      </item>
	...
	output to be produced.
      ...
      <item><strong>Version</strong>
	An optional string used to specify the default version informatio
	in output to be produced.
      </item>
...
@"        library to function. Aborting");
  ...
  argsRecognized = [NSDictionary dictionaryWithObjectsAndKeys:
    ...
    @"Version",
    @"\t\tSTR\t(\"\")\n\tdefault version for output. Should be set by gnustep-make",
    @"StylesheetURL",
