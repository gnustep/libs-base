  ...
  if (nil == saved)
      ...
      if (nil == s)
	{
	  s = [[[NSProcessInfo processInfo] environment]
	    objectForKey: @"SOURCE_AUTHOR_CREDIT"];
	}
      if (nil == s)
	{
	  s = [NSString stringWithFormat: @"Generated by %@", NSFullUserName()];
	}
      s = [s stringByEscapingXML];
      saved = [s copy];
    }
  return saved;
}
  ...
  if (authors == nil)
    {
      ...
      [str appendString: [AGSOutput authorCredit]];
